        ...
        <div className="flex-1 overflow-y-auto px-10 py-8">
          {loading ? (
            <div className="rounded-2xl border border-white/10 bg-card px-8 py-14 text-center shadow-sm">
              <p className="text-white/60">Loading decks...</p>
            </div>
          ) : rootDecks.length === 0 ? (
            <div className="rounded-2xl border border-white/10 bg-card px-8 py-14 text-center shadow-sm">
              ...
              <div className="flex items-center justify-between px-5 py-3 bg-white/5 border-b border-white/10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="grid grid-cols-4 w-52 gap-3">
                    <span className="text-xs text-right text-white/60">New</span>
                    <span className="text-xs text-right text-white/60">Learning</span>
                    <span className="text-xs text-right text-white/60">Review</span>
                    <span className="text-xs text-right text-white/60">Total</span>
                  </div>
